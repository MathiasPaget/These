...
\tikzset{ActNode/.style={shape=circle,draw, fill=teal!70}}
\tikzset{CenterNode/.style={shape=circle,draw, fill=red!70}}
\tikzset{AddLink/.style={color=red!70}}
...
\foreach \l in {1,...,\W}{
	...
	\ifthenelse{\UJ=1}{
		\draw (\x/2,-\x/2) node[ActNode] {};
		\draw (\y/2,-\x/2) node[ActNode] {};
		\draw (\x/2,-\y/2) node[ActNode] {};
		\draw (\y/2,-\y/2) node[ActNode] {};
	...
	\ifthenelse{\ST=1}{
		...
		\draw (3/2,-2/2) node[ActNode] {};
		\draw (5/2,-2/2) node[ActNode] {};
		\draw (3/2,-6/2) node[ActNode] {};
		\draw (5/2,-6/2) node[ActNode] {};
		\draw (2/2,-3/2) node[ActNode] {};
		\draw (2/2,-5/2) node[ActNode] {};
		\draw (6/2,-3/2) node[ActNode] {};
		\draw (6/2,-5/2) node[ActNode] {};
		
		\draw (2/2,-0/2) node[ActNode] {};
		\draw (6/2,-0/2) node[ActNode] {};
		\draw (2/2,-8/2) node[ActNode] {};
		\draw (6/2,-8/2) node[ActNode] {};
		\draw (0/2,-2/2) node[ActNode] {};
		\draw (0/2,-6/2) node[ActNode] {};
		\draw (8/2,-2/2) node[ActNode] {};
		\draw (8/2,-6/2) node[ActNode] {};				
